...
class VimeoTest < Minitest::Test
  ...
  def test_transform_with_allow_fullscreen_option
    result = auto_html('http://www.vimeo.com/3300155') { vimeo(allow_fullscreen: true) }
    assert_equal '<iframe src="//player.vimeo.com/video/3300155?title=0&byline=0&portrait=0" width="440" height="248" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>', result
  end
end
